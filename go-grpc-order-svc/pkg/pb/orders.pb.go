...
func (x *CreateOrderRequest) Reset() {
	*x = CreateOrderRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_pb_orders_proto_msgTypes[0]
...
func (*CreateOrderRequest) Descriptor() ([]byte, []int) {
	return file_pkg_pb_orders_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateOrderResponse) Reset() {
	*x = CreateOrderResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_pb_orders_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateOrderResponse) Descriptor() ([]byte, []int) {
	return file_pkg_pb_orders_proto_rawDescGZIP(), []int{1}
}
...
var File_pkg_pb_orders_proto protoreflect.FileDescriptor

var file_pkg_pb_orders_proto_rawDesc = []byte{
	0x0a, 0x13, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x66, 0x0a, 0x12,
	...
	0x65, 0x72, 0x49, 0x64, 0x22, 0x53, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x32, 0x56, 0x0a, 0x0c, 0x4f, 0x72, 0x64,
...
var (
	file_pkg_pb_orders_proto_rawDescOnce sync.Once
	file_pkg_pb_orders_proto_rawDescData = file_pkg_pb_orders_proto_rawDesc
)

func file_pkg_pb_orders_proto_rawDescGZIP() []byte {
	file_pkg_pb_orders_proto_rawDescOnce.Do(func() {
		file_pkg_pb_orders_proto_rawDescData = protoimpl.X.CompressGZIP(file_pkg_pb_orders_proto_rawDescData)
	})
	return file_pkg_pb_orders_proto_rawDescData
}

var file_pkg_pb_orders_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_pb_orders_proto_goTypes = []interface{}{
	(*CreateOrderRequest)(nil),  // 0: order.CreateOrderRequest
	(*CreateOrderResponse)(nil), // 1: order.CreateOrderResponse
}
var file_pkg_pb_orders_proto_depIdxs = []int32{
...
func init() { file_pkg_pb_orders_proto_init() }
func file_pkg_pb_orders_proto_init() {
	if File_pkg_pb_orders_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pkg_pb_orders_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_pb_orders_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pkg_pb_orders_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_pkg_pb_orders_proto_goTypes,
		DependencyIndexes: file_pkg_pb_orders_proto_depIdxs,
		MessageInfos:      file_pkg_pb_orders_proto_msgTypes,
	}.Build()
	File_pkg_pb_orders_proto = out.File
	file_pkg_pb_orders_proto_rawDesc = nil
	file_pkg_pb_orders_proto_goTypes = nil
	file_pkg_pb_orders_proto_depIdxs = nil
}
